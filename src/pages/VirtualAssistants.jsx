      ...
      <div className="shell">
        ...
        <div className="va-bento-grid">
          <div className="va-bento-card card-large">
            <img src="/va-voice.jpg" alt="Voz y Texto" className="bento-bg" />
          ...
          <div className="va-bento-card card-small">
            <img src="/va-memory.jpg" alt="Memoria" className="bento-bg" />
            <div className="bento-content">
          ...
          <div className="va-bento-card card-small">
            <img src="/va-action.jpg" alt="Acción" className="bento-bg" />
            <div className="bento-content">
